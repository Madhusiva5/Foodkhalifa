        ...
        {toggleMenu && (
          <div className="app__navbar-smallscreen_overlay flex__center slide-bottom">
            ...
            <ul className="app__navbar-smallscreen_links">
              ...
              <li><a href="/ph" onClick={() => setToggleMenu(false)}><NavLink to="/menu">Menu</NavLink></a></li>
             
              <li><a href="/dec" onClick={() => setToggleMenu(false)}><NavLink to="/dec">Function Decors</NavLink></a></li>
